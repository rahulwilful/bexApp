        ...
        <View style={[ES.fx1]}>
          <View
            ...
            <Image
              source={
                isProductImages
                  ? {uri: props.product.thumbnailImage.filePath}
                  : {
                      uri: 'https://bex-dev-bucket.s3.ap-south-1.amazonaws.com/400x400-image-1686744310296.png',
                    }
              }
              style={[
                ES.w100,
                ES.h100,
              ]} /* style={[ES.w100,ES.objectFitCover]} */
            />
          </View>
        </View>
        <View style={[ES.fx2]}>
          <View style={[ES.fx2, ES.flexRow]}>
            <View style={[ES.fx8, ES.p06]}>
              <View style={[ES.fx3, ES.px1, ES.justifyContentCenter]}>
                <Text style={[ES.textDark, ES.f14, ES.textJustify]}>
                  {props.product?.name.length <= 27
                    ? props.product?.name
                    : props.product?.name.slice(0, 27) + '...'}
                </Text>
              </View>
              <View style={[ES.fx2, ES.flexRow, ES.px06]}>
                ...
                <View style={[ES.fx1, ES.justifyContentEnd]}>
                  <Text
                    ...
                    {props.product?.pricing?.offerPercentage.toFixed(2) || ''}%
                    OFF
                  </Text>
                </View>
              </View>
              ...
              <View
                style={[
                  ...
                  props.cart ? ES.dBlock : ES.dNone,
                ]}>
                <View style={[, ES.flexRow, ES.gap1]}>
                  <TouchableOpacity
                    disabled={props.product?.quantity <= 1 ? true : false}
                    onPress={() => dispatch(decreaseQuantity(props.product))}>
                    <Image
                      source={MinusIcon}
                      style={[{width: 17, height: 17}, ES.objectFitContain]}
                    />
                  </TouchableOpacity>
                </View>

                <View>
                  <Text style={[ES.f18, ES.fwM, ES.textDark]}>
                    {props.product?.quantity}
                  </Text>
                </View>
                <View style={[, ES.flexRow, ES.gap1]}>
                  <TouchableOpacity
                    onPress={() => dispatch(increaseQuantity(props.product))}>
                    <Image
                      source={PlusIcon}
                      style={[{width: 17, height: 17}, ES.objectFitContain]}
                    />
            ...
            <View
              ...
              <View style={[ES.fx2, ES.centerItems]}>
                <TouchableOpacity
                  onPress={() => {
                    itemInCart ? handleRemoveFromCart() : handleAddToCart();
                  }}>
                  <Image
                    source={itemInCart ? RedHeartIcon : HeartBlueIcon}
                    style={[{width: 24, height: 24}, ES.objectFitContain]}
                  />
                </TouchableOpacity>
              </View>
              <View style={[ES.fx1, ES.centerItems]}></View>
               ...
               <View style={[ES.fx2,props.cart ? ES.dBlock: ES.dNone]}>
            <View style={[ES.fx2, ES.centerItems]}>
              <Image source={ShareIcon} />
            </View>
            <View style={[ES.fx2, ES.centerItems]}>
              ...
              <Image source={TrashIcon} style={[{width: 54, height: 54},ES.objectFitContain]} />
              </TouchableOpacity>
            </View>
            <View style={[ES.fx1, ES.centerItems]}></View>
          </View>
